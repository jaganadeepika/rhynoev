...
const Product = () => {
  ...
  return (
    <div className='Container'>
      <div className='bike'>
        <div className='se03'>
          <h1>Introducing SE03</h1>
          <h2>Experience power and range in perfect harmony with Rhyno's 2000W motor and 55km/h max speed.</h2>
      ...
      <p className='context'>Offering an exhilarating experience with its robust 2000W motor, it ensures a thrilling ride while still delivering an impressive 80-100km range on a single charge. Like its counterparts, this machine features the safety assurance of a fire-safe advanced LFP battery, along with the comprehensive benefits of owning a Rhyno. Boasting a formidable combination of a 2000W motor and a 2.7kWh battery, this beast is ready to roar on the roads, providing an electrifying journey at every turn.<br/> Check out the other details below!
           ...
           <div className='row1'>
            <div className='col2'>
            <h2>Battery</h2>
            <p><strong>2.7Kwh</strong> LFP battery with 1500 Cycles,Active Balancing, <br/>waterproof,3-year Warranty and 3-hour Charge time(12A) </p>
            </div>
           ...
           <div className='row1'>
            ...
            <div className='row2'>
            <p><b className='Icon'><FaTachometerAlt /><br/>55Km/h<br/></b>Max Speed</p>
            <p><b className='Icon'><br/>150km <br/></b>Max range<br/>(30Km/h)</p>
            <p><b className='Icon'><FaRoad/><br/>90Km <br/></b>Max range<br/>(Full speed)</p>
            <p><b className='Icon'><br/>110Km <br/></b>Max range<br/>(45Km/h)</p>
            </div>
           </div>
           <img src={motor} alt="" width={300} height={200}/>
           </div>
      </div>
    </div>
  );
